...
bool equal( set< T, T1 > &set1, std::set< T, T2 > &set2 )
{
   ...
   {
      color1 = static_cast< char >( *( head1 + 3 ) & 0x00000000000000FFULL );
      color2 = static_cast< char >( *( head2 + 3 ) & 0x00000000000000FFULL );
//      color1 = static_cast< char >( *( head1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( head2 + 3 ) % 256 );

      isNil1 = static_cast< char >( ( *( head1 + 3 ) & 0x000000000000FF00ULL ) >> 8 );
      isNil2 = static_cast< char >( ( *( head2 + 3 ) & 0x000000000000FF00ULL ) >> 8 );
//      isNil1 = static_cast< char >( *( head1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( head2 + 3 ) / 256 % 256 );
   }
   else // x86 platform
   {
      color1 = static_cast< char >( *( head1 + 3 ) & 0x000000FFUL );
      color2 = static_cast< char >( *( head2 + 3 ) & 0x000000FFUL );
//      color1 = static_cast< char >( *( head1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( head2 + 3 ) % 256 );

      isNil1 = static_cast< char >( ( *( head1 + 3 ) & 0x0000FF00UL ) >> 8 );
      isNil2 = static_cast< char >( ( *( head2 + 3 ) & 0x0000FF00UL ) >> 8 );
//      isNil1 = static_cast< char >( *( head1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( head2 + 3 ) / 256 % 256 );
   }
   ...
   // root1->parent != head1
   if( *( reinterpret_cast< size_t ** >( root1 ) + 1 ) != head1 )
      return false;

   // root1->left != minimum( root1, head1 )
   if( *( reinterpret_cast< size_t ** >( head1 ) ) != minimum( root1, head1 ) )
      return false;

   // root1->right != minimum( root1, head1 )
...
bool equal( size_t *node1, size_t *head1, size_t *node2, size_t *head2 )
{
   ...
   if( sizeof( size_t ) == 8 ) // x64 platform
   {
      color1 = static_cast< char >( *( node1 + 3 ) & 0x00000000000000FFULL );
      color2 = static_cast< char >( *( node2 + 3 ) & 0x00000000000000FFULL );
//      color1 = static_cast< char >( *( node1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( node2 + 3 ) % 256 );

      isNil1 = static_cast< char >( ( *( node1 + 3 ) & 0x000000000000FF00ULL ) >> 8 );
      isNil2 = static_cast< char >( ( *( node2 + 3 ) & 0x000000000000FF00ULL ) >> 8 );
...
//      isNil2 = static_cast< char >( *( node2 + 3 ) / 256 % 256 );
      ...
      {
      case 1:
         myVal1 = static_cast< Kty >( ( *( node1 + 3 ) & 0x0000000000FF0000ULL ) >> 16 );
         myVal2 = static_cast< Kty >( ( *( node2 + 3 ) & 0x0000000000FF0000ULL ) >> 16 );
//         myVal1 = static_cast< Kty >( *( node1 + 3 ) / 65536 % 256 );
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 % 256 );
         break;
      case 2:
         myVal1 = static_cast< Kty >( ( *( node1 + 3 ) & 0x00000000FFFF0000ULL ) >> 16 );
         myVal2 = static_cast< Kty >( ( *( node2 + 3 ) & 0x00000000FFFF0000ULL ) >> 16 );
//         myVal1 = static_cast< Kty >( *( node1 + 3 ) / 65536 % twoTo32 );
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 % twoTo32 );
         break;
      case 4:
         myVal1 = static_cast< Kty >( ( *( node1 + 3 ) & 0xFFFFFFFF00000000ULL ) >> 32 );
         myVal2 = static_cast< Kty >( ( *( node2 + 3 ) & 0xFFFFFFFF00000000ULL ) >> 32 );
...
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / twoTo32 );
   ...
   {
      color1 = static_cast< char >( *( node1 + 3 ) & 0x000000FFUL );
      color2 = static_cast< char >( *( node2 + 3 ) & 0x000000FFUL );
//      color1 = static_cast< char >( *( node1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( node2 + 3 ) % 256 );

      isNil1 = static_cast< char >( ( *( node1 + 3 ) & 0x0000FF00UL ) >> 8 );
      isNil2 = static_cast< char >( ( *( node2 + 3 ) & 0x0000FF00UL ) >> 8 );
//      isNil1 = static_cast< char >( *( node1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( node2 + 3 ) / 256 % 256 );
      ...
      {
      case 1:
         myVal1 = static_cast< Kty >( ( *( node1 + 3 ) & 0x00FF0000UL ) >> 16 );
         myVal2 = static_cast< Kty >( ( *( node2 + 3 ) & 0x00FF0000UL ) >> 16 );
//         myVal1 = static_cast< Kty >( *( node1 + 3 ) / 65536 % 256 );
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 % 256 );
         break;
      case 2:
         myVal1 = static_cast< Kty >( ( *( node1 + 3 ) & 0xFFFF0000UL ) >> 16 );
         myVal2 = static_cast< Kty >( ( *( node2 + 3 ) & 0xFFFF0000UL ) >> 16 );
...
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 );
   ...
   if( leftChild1 != head1 )             // leftChild1->parent != node1
      if( *( reinterpret_cast< size_t ** >( leftChild1 ) + 1 ) != node1 )
         return false;

   if( rightChild1 != head1 )            // rightChild1->parent != node1
      if( *( reinterpret_cast< size_t ** >( rightChild1 ) + 1 ) != node1 )
         return false;
